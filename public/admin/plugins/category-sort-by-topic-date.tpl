<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Category Sort by Topic Date</div>
...
$(document).ready(function() {
	...
	function startProgress(msg) {
		function checkProgress() {
			socket.emit('admin.plugins.categorySortByTopicDate.checkProgress', function(err, progress) {
				if (err) {
					clearProgress();
	...
	$('#reindex').on('click', function() {
		socket.emit('admin.plugins.categorySortByTopicDate.reindex', function(err, data) {
			if (err) {
